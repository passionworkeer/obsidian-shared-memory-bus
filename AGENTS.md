...
This project is indexed by GitNexus as **obsidian-shared-memory-bus** (7898 symbols, 12843 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
