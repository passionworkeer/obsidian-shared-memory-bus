...
// ---------------------------------------------------------------------------
// Vault root resolution (same pattern as build-l0-l1-bootstrap.js)
// ---------------------------------------------------------------------------
...
function loadVaultRootHelper() {
  ...
  return null;  // no helper found
}

function resolveVaultRoot() {
  const helper = loadVaultRootHelper();
  if (helper) {
    try {
      return helper.resolveVaultRoot();
    } catch {
