...
# Q-HIGH-1 step 5.1: text utils / tokenize / structured-files moved to
# retrieval/search_text_utils.py. Re-export below keeps the
# `from search_ranking import (...)` contract intact for downstream
# (semantic_search, search_index, search_cache, search_server,
# tests/cross-language/shared-config-parity.test.js,
# tests/unit/py/test_search_cache.py).
from search_text_utils import (  # noqa: F401 — re-export
    BM25Okapi,
